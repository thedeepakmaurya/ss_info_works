...
export default function PricePage() {
  ...
  return (
    <section className="container grid gap-20 lg:grid-cols-3">
      {pricing.map(({ title, description, price, features, icon }, index) => {
        ...
        return (
          <div
            key={index}
            className="group relative overflow-hidden rounded-xl bg-orange-100 shadow transition-all duration-300 ease-in-out hover:bg-blue-100"
          >
